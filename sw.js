const CACHE='guanshan-v8';
const ASSETS=['./','./index.html','./styles.css','./library.js','./app.js','./manifest.json','./assets/photos/mingtang-levels.jpg','./assets/photos/five-stars-pass.jpg'];
