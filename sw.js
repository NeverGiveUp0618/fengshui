const CACHE='guanshan-v12-audit';
const ASSETS=['./','./index.html','./styles.css','./library.js','./image-bank.js','./app.js','./manifest.json','./assets/photos/mingtang-levels.jpg','./assets/photos/five-stars-pass.jpg'];
